...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--time_suffix', action='store_true', help='if time_suffix is set and suffix is empty, the suffix will be set to a str of timestamp.')
    ...
    def parse(self):
        ...
        if opt.time_suffix and opt.suffix == '':
            opt.suffix = time.strftime("%Y%m%d_%H_%M", time.localtime())
